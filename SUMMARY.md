...
* [IP Address Functions](functions/ip-address-functions.md)
* [JSON Functions](users/user-guide-query/json-queries.md)
* [Math Functions](functions/math-functions.md)
* [Null Handling Functions](functions/null-handling-functions.md)
* [String Functions](functions/string-functions.md)
* [Trigonometric Functions](functions/trigonometric-functions.md)
* [Type Conversion Functions](functions/type-conversion-functions.md)
* [User-Defined Functions (UDFs)](users/user-guide-query/scalar-functions.md)
* [Vector / Similarity Functions](functions/vector-functions.md)
