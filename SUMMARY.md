...
* [Query](users/user-guide-query/README.md)
  ...
  * [Query Syntax](users/user-guide-query/query-syntax/README.md)
    ...
    * [GapFill Function For Time-Series Dataset](users/user-guide-query/query-syntax/gap-fill-functions/README.md)
    ...
    * [Transformation Functions](users/user-guide-query/query-syntax/gap-fill-functions/supported-transformations.md)
