...
* [Query](users/user-guide-query/README.md)
  ...
  * [Query Syntax](users/user-guide-query/query-syntax/README.md)
    * [Aggregation Functions](users/user-guide-query/query-syntax/supported-aggregations.md)
    * [Cardinality Estimation](users/user-guide-query/query-syntax/how-to-handle-unique-counting.md)
    * [Explain Plan](users/user-guide-query/query-syntax/explain-plan.md)
    ...
    * [Grouping Algorithm](users/user-guide-query/query-syntax/grouping-algorithm.md)
...
* [Functions](configuration-reference/functions/README.md)
  ...
  * [ARG\_MIN / ARG\_MAX](configuration-reference/functions/arg\_min-arg\_max.md)
