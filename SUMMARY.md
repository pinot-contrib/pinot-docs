...
* [Getting started](basics/getting-started/README.md)
  ...
  * [Running Pinot in the Cloud](basics/getting-started/quickstart/README.md)
    * [AWS Quickstart](basics/getting-started/quickstart/aws-quickstart.md)
    * [GCP Quickstart](basics/getting-started/quickstart/gcp-quickstart.md)
    * [Azure Quickstart](basics/getting-started/quickstart/azure-quickstart.md)
  * [Pinot Data Explorer](basics/getting-started/exploring-pinot.md)
...
* [Components](reference/components/README.md)
  * [Cluster](reference/components/cluster.md)
  * [Controller](reference/components/controller.md)
  * [Broker](reference/components/broker.md)
  * [Server](reference/components/server.md)
  * [Minion](reference/components/minion.md)
  * [Tenant](reference/components/tenant.md)
  * [Table](reference/components/table.md)
  * [Schema](reference/components/schema.md)
  * [Segment](reference/components/segment.md)
* [Features](reference/features/README.md)
  * [Text Search Support](reference/features/text-search-support.md)
  * [Indexing](reference/features/indexing.md)
* [Releases](reference/releases/README.md)
  * [0.3.0](reference/releases/0.3.0.md)
  * [0.2.0](reference/releases/0.2.0.md)
  * [0.1.0](reference/releases/1.0.md)
