...
- [Basic Auth Access Control](authentication/basic-auth-access-control.md) -- HTTP Basic Auth setup for controller and broker
- [ZK Basic Auth Access Control](authentication/zkbasicauthaccesscontrol.md) -- ZooKeeper-managed auth with hot deployment
