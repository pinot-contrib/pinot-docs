...
1. Follow the steps described in the section on [Compiling the code](../../basics/getting-started/README.md) to build pinot. Locate `pinot-admin.sh` in `pinot-tools/target/pinot-tools=pkg/bin/pinot-admin.sh`.
