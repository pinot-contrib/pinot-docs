...
| <p>​<a href="../../functions/json/jsonextractkey.md"><strong>JSONEXTRACTKEY</strong></a>​<a href="../../functions/json/jsonextractscalar.md"><strong>(jsonField, 'jsonPath', ['paramString'])</strong></a> </p><p>Extracts all matched JSON field keys based on <code>'jsonPath'</code> into a <code>STRING_ARRAY.</code></p>                                                                                       |
