...
Since the 0.5.0 release, Pinot supports custom functions that return a single output for multiple inputs. Examples of scalar functions can be found in [StringFunctions](../../users/user-guide-query/supported-transformations.md#string-functions) and [DateTimeFunctions](../../users/user-guide-query/supported-transformations.md#datetime-functions)
