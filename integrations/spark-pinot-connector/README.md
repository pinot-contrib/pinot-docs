...
You can run the examples locally (e.g. using your IDE) in a standalone mode by starting a local Pinot cluster. See: [docs](../../basics/getting-started/install/local.md)
