...
You can check out [Batch Ingestion](../../basics/data-import/batch-ingestion/), [File systems](../../basics/data-import/pinot-file-system/) and [Input formats](../../basics/data-import/pinot-input-formats/) for all the available plugins.
...
You can check out [Command-Line Interface (CLI)](../../for-operators/cli.md) for all the available commands.
