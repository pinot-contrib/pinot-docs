...
Filter config also supports SQL-like expression of built-in [scalar functions](../../for-users/user-guide-query/scalar-functions.md#scalar-functions) for filtering records (starting v 0.11.0+). Example:
