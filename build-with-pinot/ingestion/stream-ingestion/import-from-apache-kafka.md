...
There is a standalone utility to generate the schema from an Avro file. See [infer the pinot schema from the avro schema and JSON data](../../../manage-data/data-import/complex-type#infer-the-pinot-schema-from-the-avro-schema-and-json-data) for details.
