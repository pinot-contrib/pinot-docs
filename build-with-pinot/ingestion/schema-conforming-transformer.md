...
Specifically, customizable json index could be set according to [json index indexPaths](../../build-with-pinot/indexing/json-index.md#enable-and-configure-a-json-index).
