...
As explained in [explain-plan-multiple-stages](../../query-execution-controls/explain-plan-multi-stage.md), the explain plan in the multi-stage query engine does not indicate whether indexes are used or not.
...
As explained in [explain-plan-multiple-stages](../../query-execution-controls/explain-plan-multi-stage.md), the explain plan in the multi-stage query engine does not directly indicate whether indexes are used or not.
