...
| **enableNullHandling** | Enables advanced null handling. See [Null value support](../null-value-support.md) for more information.(introduced in 0.11.0) | `false` (disabled) |
