...
| pinotServerTimeoutMs  | The maximum timeout(ms) to get data from pinot server                                                                                                                                                 | No       | 10000 (10 seconds)                                    |
...
| grpc.use-plain-text   | Use plaintext for gRPC (overrides `secureMode` for gRPC). If this option is not set, `secureMode=true` implies TLS (`grpc.use-plain-text=false`).                                                     | No       | true                                                  |
| grpc.port             | Pinot server gRPC port to use when `useGrpcServer=true`.                                                                                                                                              | No       | 8090                                                  |
| grpc.max-inbound-message-size | Maximum inbound gRPC message size (bytes) for Spark executors receiving streaming responses.                                                                                                  | No       | 134217728 (128 MB)                                    |
| grpc.tls.keystore-type | gRPC TLS keystore type.                                                                                                                                                                              | No       | JKS                                                   |
| grpc.tls.keystore-path | gRPC TLS keystore file path. Required when using gRPC TLS with mutual TLS or client cert auth.                                                                                                       | No       | None                                                  |
| grpc.tls.keystore-password | gRPC TLS keystore password.                                                                                                                                                                      | No       | None                                                  |
| grpc.tls.truststore-type | gRPC TLS truststore type.                                                                                                                                                                          | No       | JKS                                                   |
| grpc.tls.truststore-path | gRPC TLS truststore file path.                                                                                                                                                                     | No       | None                                                  |
| grpc.tls.truststore-password | gRPC TLS truststore password.                                                                                                                                                                | No       | None                                                  |
| grpc.tls.ssl-provider | SSL provider used for gRPC TLS (for example, `JDK`).                                                                                                                                                  | No       | JDK                                                   |
| proxy.enabled         | Enable Pinot proxy support for controller and broker discovery.                                                                                                                                       | No       | false                                                 |
| grpc.proxy-uri        | Proxy URI for gRPC requests (only used when `proxy.enabled=true`).                                                                                                                                    | No       | None                                                  |
