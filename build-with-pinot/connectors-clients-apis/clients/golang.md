...
1. Follow this [Pinot quickstart](../../../basics/getting-started/quick-start.md#batch-processing) to install and start Pinot locally.
...
3. Build and run the example application to query from the [Pinot batch quickstart](../../../basics/getting-started/quick-start.md#batch-processing).
