...
Each operator has its own set of statistics, which are collected during the execution of the query. See the [Operator Types](operator-types/) section to learn more about the different operator types and their statistics.
