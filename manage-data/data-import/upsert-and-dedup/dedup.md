...
* For Dedup tables, it is not recommended to update primary key columns or the dedupTimeColumn, as doing so may lead to data loss and inconsistencies between replicas.
