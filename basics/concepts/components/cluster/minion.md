...
See [Pinot managed Offline flows](../../../../for-operators/operating-pinot/pinot-managed-offline-flows.md) for details.

### MergeRollupTask

See [Minion merge rollup task](../../../../for-operators/operating-pinot/minion-merge-rollup-task.md) for details.
