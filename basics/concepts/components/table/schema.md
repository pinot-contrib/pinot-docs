...
* Whether the table uses column-based or table-based null handling. For more information, see [Null value support](https://github.com/pinot-contrib/pinot-docs/blob/latest/basics/developers/advanced/null-value-support.md).
