...
Initial (phase 1) Query runtime for window functions with ORDER BY within the OVER() clause ([#10449](https://github.com/apache/pinot/pull/10449))\
...
Enhanced the multi-stage group-by executor to support limiting the number of groups, improving query performance and resource utilization ([#11424](https://github.com/apache/pinot/pull/11424)).\
