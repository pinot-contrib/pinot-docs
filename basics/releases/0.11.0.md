...
\
More to read: [docs](../../reference/multi-stage-engine.md)
...
This allows users to have better query performance on the timestamp column for lower granularity. See: [docs](../../configuration-reference/indexing/timestamp-index.md)
...
Now you can use `INSERT INTO [database.]table FROM FILE dataDirURI OPTION ( k=v ) [, OPTION (k=v)]*` to load data into Pinot from a file using Minion. See: [docs](../../manage-data/data-import/from-query-console.md)
