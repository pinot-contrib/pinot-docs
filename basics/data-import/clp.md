...
* We use [variable-length dictionaries](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/table/README.md#table-index-config) for the logtype and dictionary variables since their length can vary significantly.
...
To decode CLP-encoded fields, use [CLPDECODE](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/clpdecode.md).
