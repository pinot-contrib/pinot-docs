...
| stream.\[streamType].consumer.type                   | Whether to use per partition low-level consumer or high-level stream consumer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | <ul><li><code>lowLevel</code> - Consume data without control over the partitions</li><li><code>highLevel</code> - Consume data from each partition with offset management</li></ul>                                                                                                                                                                                                                                             |
