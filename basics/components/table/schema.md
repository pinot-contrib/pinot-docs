...
* Whether the table uses column-based or table-based null handling. For more information, see [Null value support](../../../build-with-pinot/querying-and-sql/null-value-support.md).
