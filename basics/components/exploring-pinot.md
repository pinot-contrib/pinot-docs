...
To learn how to upload your own data and schema, see [Batch Ingestion](../../build-with-pinot/ingestion/batch-ingestion) or [Stream ingestion](../../manage-data/data-import/pinot-stream-ingestion/).
