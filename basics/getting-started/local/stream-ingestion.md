---
description: Step-by-step guide for streaming ingestion into a local Pinot installation
---

# Stream ingestion (local)

This guide walks you through setting up real-time stream ingestion into a Pinot cluster running locally. Make sure you have completed [Running Pinot locally](../local/) first.
...
**Create a Kafka topic.** Download the latest [Kafka](https://kafka.apache.org/quickstart#quickstart_download), then create a topic:
