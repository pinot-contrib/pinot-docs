...
(Optional) You can also follow the instructions [here](../develop-contribute/build-docker-images.md) to build your own images.
...
Below are some configurations you can set in Pinot Controller. You can head over to [Controller](../reference/configuration-reference/controller.md#primary-configuration) for complete list of available configs.
...
Below are some configurations you can set in Pinot Broker. You can head over to [Broker](../reference/configuration-reference/broker.md) for complete list of available configs.
...
Below are some outstanding configurations you can set in Pinot Server. You can head over to [Server](../reference/configuration-reference/server.md) for complete list of available configs.
...
When you update this setting in your table configuration, you must [reload the table segment](segment-reload.md) to apply the inverted index to all existing segments.
