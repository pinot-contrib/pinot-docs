...
Then, use these [json functions](../../functions/transformations.md#json-functions) during query time, to extract fields from the json string.
...
Star-tree indexes are configured in the table configuration under the `tableIndexConfig` -&gt; `starTreeIndexConfigs` \(list\) and `enableDefaultStarTree` \(boolean\). See here to learn more about how to configure star-tree indexes: [docs](../../README.md)
...
See this page which explains the Pinot response format: [docs](../../reference/api-reference/query-response-format.md).
