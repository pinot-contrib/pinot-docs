...
* [Optimizing Scatter and Gather](routing.md) -- partition pruning, replica-group routing, and fanout reduction
* [Query Scheduling](query-scheduling.md) -- control query concurrency and prioritization on servers
* [Workload-Based Query Isolation](workload-query-isolation.md) -- isolate production vs. ad-hoc query resources
