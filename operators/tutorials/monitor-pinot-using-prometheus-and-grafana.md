...
![Sample output of JMX metrics](<../../.gitbook/assets/image (12).png>)
...
![Prometheus data source config](<../../.gitbook/assets/image (52).png>)

* Configure Pinot Dashboard

Once data source is added, we can import a Pinot Dashboard:

![Grafana Import Button](<../../.gitbook/assets/image (33).png>)
...
![Grafana Import Page](<../../.gitbook/assets/image (9).png>)
