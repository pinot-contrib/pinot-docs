...
{% hint style="info" %}
The multi-stage engine was introduced experimentally in this release (0.11.0) and became production-ready in Pinot 1.0.0. For current documentation, see [SSE vs MSE](../../build-with-pinot/querying-and-sql/sse-vs-mse.md) and [Troubleshooting MSE](../../operate-pinot/troubleshooting/troubleshoot-multi-stage-query-engine.md).
{% endhint %}

The multi-stage query engine (also called MSE or v2) was designed to support more complex SQL semantics such as JOIN, OVER window, MATCH\_RECOGNIZE and eventually, make Pinot support closer to full ANSI SQL semantics.\
\
More to read: [SSE vs MSE](../../build-with-pinot/querying-and-sql/sse-vs-mse.md)

![](https://user-images.githubusercontent.com/1202120/188030548-9d9eb8fa-ffbe-41c2-bad6-0fb3d85eef09.png)
...
![](https://user-images.githubusercontent.com/1202120/188030580-a3760d22-b699-4882-b13f-bb07375a504e.png)
...
This allows users to have better query performance on the timestamp column for lower granularity. See: [docs](../../build-with-pinot/indexing/timestamp-index.md)
...
Now you can use `INSERT INTO [database.]table FROM FILE dataDirURI OPTION ( k=v ) [, OPTION (k=v)]*` to load data into Pinot from a file using Minion. See: [docs](../../build-with-pinot/ingestion/from-query-console.md)
