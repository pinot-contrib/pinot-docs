...
You can also query using the `pinot-admin` scripts. Make sure you follow instructions in [Getting Pinot](../../../basics/getting-started/install/local.md#1-download-or-build-apache-pinot) to get Pinot locally, and then
