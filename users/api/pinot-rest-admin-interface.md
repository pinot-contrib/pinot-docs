...
Note: The controller API's are primarily for admin tasks. Even though the UI console queries Pinot when running queries from the query console, use the [Broker Query API](querying-pinot-using-standard-sql/README.md) for querying Pinot.
