...
For column type **INT**/**LONG**/**FLOAT**/**DOUBLE**/**STRING** , Pinot treats each value as an individual entry to add into HyperLogLog Object, then compute the approximation by calling method _**cardinality()**.
...
For column type **INT**/**LONG**/**FLOAT**/**DOUBLE**/**STRING** , Pinot treats each value as an individual entry to add into HyperLogLogPlus Object, then compute the approximation by calling method _**cardinality()**.
...
All deserialized HyperLogLogPlus object will be merged into one then calling method _**cardinality()** to get the approximated unique count._
