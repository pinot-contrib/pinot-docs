...
| <p>​<a href="../../functions-1/jsonextractkey.md"><strong>JSONEXTRACTKEY</strong></a>​<a href="../../functions-1/jsonextractscalar.md"><strong>(</strong>jsonField, 'jsonPath'<strong>)</strong></a> </p><p>Extracts all matched JSON field keys based on <code>'jsonPath'</code> into a <code>STRING_ARRAY.</code></p>                                                                                       |
...
| Function                                                                                                                                                                                                                                                                                                                          |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ​[**TOJSONMAPSTR**(map) Convert map to JSON String](../../functions-1/tojsonmapstr.md)​                                                                                                                                                                                                                                           |
