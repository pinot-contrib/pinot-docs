...
| <p><a href="../../configuration-reference/functions/regexpreplace.md"><strong>regexpReplace(input, matchRegexp, replaceRegexp, matchStartPos, occurrence, flag)</strong><br></a>Find and replace a string or regexp pattern with a target string or regexp pattern</p>           |
