...
| includeFileNamePattern   | <p>Include file name pattern, supported glob and regex patterns. E.g. </p><p><code>'glob:*.avro'</code>or <code>'regex:^.*\.(avro)$'</code> will include all avro files just under the inputDirURI, not sub directories</p><p><code>'glob:**/*.avro'</code> will include all the avro files under inputDirURI recursively.</p>                                                                                                                                                                                                                                                                     |
