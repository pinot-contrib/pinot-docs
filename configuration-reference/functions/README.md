...
{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneHour.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneHour.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneHour.md)
{% endcontent-ref %}

{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneMinute.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneMinute.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/timezoneMinute.md)
{% endcontent-ref %}
...
{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpoch.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpoch.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpoch.md)
{% endcontent-ref %}

{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochBucket.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochBucket.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochBucket.md)
{% endcontent-ref %}

{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochRounded.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochRounded.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/toEpochRounded.md)
{% endcontent-ref %}
...
{% content-ref url="https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/yearOfWeek.md" %}
[https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/yearOfWeek.md](https://github.com/pinot-contrib/pinot-docs/blob/latest/configuration-reference/functions/yearOfWeek.md)
{% endcontent-ref %}
