...
|------------------------------------|-------|-----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **schemaName**                     | -     | mandatory | Defines the name of the schema. This is usually the same as the table name. The offline and the real-time table of a hybrid table should use the same schema.                                                                                         |
| **enableColumnBasedNullHandling**  | 1.1.0 | false     | Whether to enable column-based or table-based null handling. The default value `false` means that Pinot will use a table-based null handling. See [Null value support](../developers/advanced/null-value-support.md) for more information about this. |
