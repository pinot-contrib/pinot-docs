...
| **enableColumnBasedNullHandling**  | 1.1.0           | false    | When set to true, enables column-based null handling. When set to `true`, enables column-based null handling. The default value `false` means to use table-based null handling. See [Null value support](../developers/advanced/null-value-support.md) for more information about this. |
