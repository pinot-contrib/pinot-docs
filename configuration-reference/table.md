...
| ingestionConfig      | Defines the configurations needed for ingestion level transformations. For details, see [Ingestion Level Transformations](../for-developers/advanced/ingestion-level-transformations.md) and [Ingestion Level Aggregations](../for-developers/advanced/ingestion-level-aggregations.md).                                                                                                                        |
...
| tierConfigs          | Defines configurations for tiered storage. For details, see [Tiered Storage](../for-operators/operating-pinot/separating-data-storage-by-age/moving-segments-across-tenants.md).                                                                                                                                                                                                                                |
...
| nullHandlingEnabled                        | (deprecated, use `enableColumnBasedNullHandling` in [schema](schema.md)) For more information, see the [null handling section](../for-developers/advanced/null-value-support.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
