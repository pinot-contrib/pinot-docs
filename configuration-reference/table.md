...
| tableType        | Defines the table type: `OFFLINE` for offline tables or `REALTIME` for real-time tables. A hybrid table is essentially 2 table configurations: one of each type, with the same table name.                                                                                       |
