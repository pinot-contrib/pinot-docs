...
| isDimTable           | Boolean field to indicate whether the table is a [dimension table](../manage-data/data-import/batch-ingestion/dim-table.md).                                                                                                                                                                                                                                                                                    |
...
| upsertConfig         | Set upset configurations. For details, see [Stream ingestion with upsert](../manage-data/data-import/upsert-and-dedup/upsert.md).                                                                                                                                                                                                                                                                               |
| dedupConfig          | Set deduplication configurations. For details, see [Stream ingestion with Dedup](../manage-data/data-import/upsert-and-dedup/dedup.md).                                                                                                                                                                                                                                                                         |
| dimensionTableConfig | Set `disablePreload` to `true` to save memory if the table is a [dimension table](../manage-data/data-import/batch-ingestion/dim-table.md).                                                                                                                                                                                                                                                                     |
...
| multiColumnTextIndexConfig                 | The multi-column / per-segment text index configuration. For details on how to configure this, see [Text search support](../basics/indexing/text-search-support.md#enable-a-per-segment-text-index) .                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| starTreeIndexConfigs                       | The list of StarTree indexing configs for creating StarTree indexes. For details on how to configure this, see [StarTree Index](../basics/indexing/star-tree-index.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| enableDefaultStarTree                      | Boolean to indicate whether to create a default StarTree index for the segment. For details, see[ ](../basics/indexing/star-tree-index.md)[Star-Tree index](../basics/indexing/star-tree-index.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| aggregateMetrics                           | (deprecated, use [Ingestion Aggregation](../developers/advanced/ingestion-level-aggregations.md)) (only applicable for stream) set to `true` to pre-aggregate the metrics                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
