...
| stream\[streamType].consumer.prop.auto.offset.reset                                                                                                            | offset to start consuming data from. Should be one of `smallest` , `largest`, timestamp in millis, timestamp in format 'yyyy-MM-dd'T'HH:mm:ss.SSSZ' or Valid Datetime interval Eg., 'P2D', 'P1M' etc,.                                     |
