...
| nullHandlingEnabled                        | (deprecated, use `enableColumnBasedNullHandling` in [schema](schema.md) instead) Read more about this in the [null handling section](../developers/advanced/null-value-support.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
