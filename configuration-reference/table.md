...
| Property                                                                                                                                                 | Description                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| schemaName                                                                                                                                               | <p><strong>Deprecated</strong>: schema name should always match the table name (without the type suffix, e.g. <code>myTable</code>), and this field should not be configured.</p><p></p><p>Name of the schema associated with the table</p>                                                                                                                                                                             |
...
| noDictionaryConfig                         | Used to configure the compression type on in on the noDictionary columns. `"noDictionaryConfig": { "column_name": "LZ4" }`. Values can be `PASS_THROUGH`, `SNAPPY` or `LZ4`. This change will affect only newly created segments. Old segments need to be re-generated.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
